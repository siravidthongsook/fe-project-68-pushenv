  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <Panel className="p-6">
          <Spinner label="กำลังโหลดหน้าจัดการ..." />
        </Panel>
      </div>
    );
  }
      ...
      <div className="space-y-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-4">
            ...
            <h1 className="font-display text-4xl">จัดการบริษัทและการจอง</h1>
            <p className="max-w-3xl text-sm leading-6 text-ink-600">
              ใช้หน้านี้สำหรับแก้ไขหรือลบบริษัท รวมถึงตรวจสอบ แก้ไข และลบการจองทั้งหมดในระบบ
            </p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <StatCard label="สถานะ" value="ผู้ดูแลระบบ" note="เส้นทางนี้ใช้ได้เฉพาะแอดมิน" />
        </div>
